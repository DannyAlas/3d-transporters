...
def label_overlap_count_map(
    label_map1: Image, label_map2: Image, overlap_count_map_destination: Image = None
) -> Image:
    """
    ...
    """
    from .._tier1 import (generate_binary_overlap_matrix, replace_intensities,
                          set_column, set_row, sum_y_projection)
