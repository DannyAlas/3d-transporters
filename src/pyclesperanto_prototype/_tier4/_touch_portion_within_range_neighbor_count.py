...
def touch_portion_within_range_neighbor_count(
    labels: Image,
    ...
    * This operation assumes input images are isotropic.
    ...
    destination
    """
    from .._tier1 import count_touching_neighbors, set_column, set_row
    ...
    touch_matrix = generate_touch_portion_within_range_neighbors_matrix(
        touch_portion_matrix,
        minimum_touch_portion=minimum_touch_portion,
        maximum_touch_portion=maximum_touch_portion,
    )
    count_vector_destination = count_touching_neighbors(
        touch_matrix, count_vector_destination
    )
