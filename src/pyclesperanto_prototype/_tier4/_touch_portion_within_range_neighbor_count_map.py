...
def touch_portion_within_range_neighbor_count_map(
    labels: Image,
    ...
    * This operation assumes input images are isotropic.
    ...
    from ._touch_portion_within_range_neighbor_count import \
        touch_portion_within_range_neighbor_count

    number_of_touching_neighbors_vector = touch_portion_within_range_neighbor_count(
        labels,
