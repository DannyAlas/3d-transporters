...
def local_minimum_touching_neighbor_count_map(
    ...
    local_minimum_vector = minimum_of_touching_neighbors(
    ...
    replace_intensities(source, local_minimum_vector, destination)
    return destination
