...
def exclude_labels_with_map_values_equal_to_constant(
    values_map: Image,
    ...
    * Values of all pixels in a label each must be identical.
    ...
    from .._tier3 import exclude_labels_with_values_equal_to_constant

    return exclude_labels_with_values_equal_to_constant(
        values_vector, label_map_input, label_map_destination, constant
    )
