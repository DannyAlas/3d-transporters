...
from .._tier0 import (Image, create_labels_like, create_like, plugin_function,
                      pull, push)
from .._tier1 import (nonzero_minimum_box, nonzero_minimum_diamond, set,
...
def connected_components_labeling_box(
    binary_input: Image,
    labeling_destination: Image = None,
    flagged_nonzero_minimum_filter: callable = nonzero_minimum_box,
) -> Image:
