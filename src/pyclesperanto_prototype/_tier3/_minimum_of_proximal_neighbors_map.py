...
def minimum_of_proximal_neighbors_map(
    ...
    by the minimum value of neighboring labels. The distance range of the centroids of the neighborhood can be configured.
