...
def mean_of_n_most_touching_neighbors_map(
    ...
    by the mean value of most touching neighboring labels. The number of most touching neighbors can be configured.
