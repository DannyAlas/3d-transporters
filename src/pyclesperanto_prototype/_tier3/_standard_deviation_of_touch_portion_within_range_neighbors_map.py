...
def standard_deviation_of_touch_portion_within_range_neighbors_map(
    ...
    by the standard_deviation of neighboring labels whose touch portion lies within a specified range. The number of most
