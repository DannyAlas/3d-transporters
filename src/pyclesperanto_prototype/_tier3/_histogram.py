...
from .._tier1 import copy_slice, sum_z_projection
from .._tier2 import maximum_of_all_pixels, minimum_of_all_pixels
...
def histogram(
    ...
    constants = {"NUMBER_OF_HISTOGRAM_BINS": num_bins}

    global_sizes = [number_of_partial_histograms]
    execute(
        __file__,
        "clij-opencl-kernels/kernels/histogram_"
        + str(len(image_to_process.shape))
        + "d_x.cl",
