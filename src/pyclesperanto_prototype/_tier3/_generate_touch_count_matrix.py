...
def generate_touch_count_matrix(
    label_map: Image, touch_count_matrix_destination: Image = None
) -> Image:
    ...
    from .._tier2 import add_images, maximum_of_all_pixels
    ...
    parameters = {"dst_neighbor_touching_count_matrix": temp1, "src_label": label_map}
