...
def generate_standard_deviation_intensity_between_points_matrix(
    ...
    if standard_deviation_intensity_matrix_destination is None:
        standard_deviation_intensity_matrix_destination = create_matrix_from_pointlists(
            pointlist, pointlist
        )
    ...
    execute(
        __file__,
        "standard_deviation_intensity_between_points_matrix_x.cl",
        "standard_deviation_intensity_between_points_matrix",
        touch_matrix.shape,
        parameters,
    )
