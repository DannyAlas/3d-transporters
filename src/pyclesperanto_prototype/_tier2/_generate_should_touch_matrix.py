from .._tier0 import Image, create_square_matrix_from_labelmap, plugin_function


@plugin_function(output_creator=create_square_matrix_from_labelmap)
def generate_should_touch_matrix(
    labels: Image, annotation_binary_mask: Image, destination_touch_matrix: Image = None
) -> Image:
    """
    ...
    """
    from .._tier1 import generate_touch_matrix, mask, set_column, set_row
