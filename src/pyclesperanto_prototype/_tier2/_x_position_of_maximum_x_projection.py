from pyclesperanto_prototype._tier0 import (Image, create_2d_yz, execute,
                                            plugin_function)
...
def x_position_of_maximum_x_projection(
    ...
    """Determines an X-position of the maximum intensity along X and writes it into the resulting image.
    ...
    execute(
        __file__,
        "x_position_of_maximum_x_projection_x.cl",
