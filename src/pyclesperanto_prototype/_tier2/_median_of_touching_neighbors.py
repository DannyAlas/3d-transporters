...
def median_of_touching_neighbors(
    values: Image, touch_matrix: Image, median_values_destination: Image = None
) -> Image:
    ...
    execute(
        __file__,
        "clij-opencl-kernels/kernels/median_of_touching_neighbors_x.cl",
        "median_value_of_touching_neighbors",
        median_values_destination.shape,
        parameters,
    )
