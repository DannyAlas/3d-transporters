...
def generate_maximum_intensity_between_points_matrix(
    ...
    if maximum_intensity_matrix_destination is None:
        maximum_intensity_matrix_destination = create_matrix_from_pointlists(
            pointlist, pointlist
        )
    ...
    execute(
        __file__,
        "maximum_intensity_between_points_matrix_x.cl",
        "maximum_intensity_between_points_matrix",
        touch_matrix.shape,
        parameters,
    )
