from pyclesperanto_prototype._tier0 import (Image, create_from_pointlist,
                                            execute, plugin_function)


@plugin_function(output_creator=create_from_pointlist)
def distance_matrix_to_mesh(
    pointlist: Image,
    ...
    """
    from .._tier1 import smaller_or_equal_constant, touch_matrix_to_mesh
