...
def mean_of_touching_neighbors(
    values: Image, touch_matrix: Image, mean_values_destination: Image = None
) -> Image:
    ...
    execute(
        __file__,
        "clij-opencl-kernels/kernels/mean_of_touching_neighbors_x.cl",
        "mean_value_of_touching_neighbors",
        mean_values_destination.shape,
        parameters,
    )
