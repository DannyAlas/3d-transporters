...
def draw_touch_portion_ratio_mesh_between_touching_labels(
    labels: Image, touch_portion_ratio_mesh_destination: Image = None
) -> Image:
    ...
    * This operation assumes input images are isotropic.
    ...
    """
    from .._tier1 import (divide_images, maximum_images, minimum_images,
                          nan_to_num, touch_matrix_to_mesh, transpose_xy)
    ...
    smaller_touch_portion_matrix = minimum_images(
        touch_portion_matrix_A_B, touch_portion_matrix_B_A
    )
    greater_touch_portion_matrix = maximum_images(
        touch_portion_matrix_A_B, touch_portion_matrix_B_A
    )

    touch_portion_ratio_matrix = divide_images(
        greater_touch_portion_matrix, smaller_touch_portion_matrix
    )
    ...
    return touch_matrix_to_mesh(
        centroids, touch_portion_ratio_matrix, touch_portion_ratio_mesh_destination
    )
