...
def draw_distance_mesh_between_proximal_labels(
    labels: Image, distance_mesh_destination: Image = None, maximum_distance: float = 1
) -> Image:
    ...
    * This operation assumes input images are isotropic.
    ...
    """
    from .._tier1 import (generate_distance_matrix, multiply_images, set,
    ...
    proximal_neighbor_matrix = generate_proximal_neighbors_matrix(
        distance_matrix, max_distance=maximum_distance
    )
