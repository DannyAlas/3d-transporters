...
@plugin_function
def draw_mesh_between_labels_with_touch_portion_in_range(
    labels: Image,
    mesh_destination: Image = None,
    ...
    * This operation assumes input images are isotropic.
    ...
    mesh_destination
    """
    from .._tier1 import binary_and, set_column, set_row, touch_matrix_to_mesh
    ...
    return touch_matrix_to_mesh(
        centroids, constrained_matrix, mesh_destination=mesh_destination
    )
