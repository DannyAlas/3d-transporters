...
def euclidean_distance_from_label_centroid_map(
    labels: Image,
    centroids_pointlist: Image = None,
    distance_map_destination: Image = None,
) -> Image:
    ...
    * This operation assumes input images are isotropic.
    ...
    """
    from .._tier0 import create_like, execute
    ...
    execute(
        __file__,
        "clij-opencl-kernels/kernels/euclidean_distance_from_label_centroid_map_x.cl",
        "euclidean_distance_from_label_centroid_map",
        distance_map_destination.shape,
        parameters,
    )
