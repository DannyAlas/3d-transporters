...
def draw_touch_portion_mesh_between_touching_labels(
    labels: Image, touch_portion_mesh_destination: Image = None
) -> Image:
    ...
    * This operation assumes input images are isotropic.
    ...
    """
    from .._tier1 import (add_images_weighted, touch_matrix_to_mesh,
                          transpose_xy)
    ...
    touch_portion_matrix = add_images_weighted(
        touch_portion_matrix_A_B, touch_portion_matrix_B_A, factor1=0.5, factor2=0.5
    )
    ...
    return touch_matrix_to_mesh(
        centroids, touch_portion_matrix, touch_portion_mesh_destination
    )
