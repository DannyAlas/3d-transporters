...
def draw_angle_mesh_between_touching_labels(
    labels: Image, angle_mesh_destination: Image = None
) -> Image:
    ...
    ----------
    """
    from .._tier1 import (generate_angle_matrix, generate_touch_matrix,
    ...
    angle_mesh_destination = touch_matrix_to_mesh(
        centroids, touch_angle_matrix, angle_mesh_destination
    )
