...
def label_standard_deviation_intensity_map(
    intensity_image: Image,
    labels: Image,
    standard_deviation_intensity_map: Image = None,
) -> Image:
    ...
    standard_deviation_intensity_map = replace_intensities(
        labels, values_vector, standard_deviation_intensity_map
    )
