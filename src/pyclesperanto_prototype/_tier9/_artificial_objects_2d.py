...
def artificial_objects_2d() -> Image:
    ...
    from .._tier1 import (detect_label_edges, draw_line, draw_sphere,
                          maximum_sphere, paste, set, set_ramp_y)
    ...
    for t in range(0, 5):
        ...
        draw_sphere(
            image, x=175, y=25 + t * 50, radius_x=(t + 1) * 2, radius_y=10, value=255
        )
        draw_sphere(
            image, x=200, y=25 + t * 50, radius_x=10, radius_y=(t + 1) * 2, value=255
        )
    ...
    for t in range(1, 10):
        draw_sphere(
            image, x=20, y=255 + (t - 1) * 30, radius_x=5 + t, radius_y=5 + t, value=255
        )
        draw_sphere(
            image, x=60, y=255 + (t - 1) * 30, radius_x=5 + t, radius_y=5 + t, value=255
        )
        draw_sphere(
            image, x=60, y=255 + (t - 1) * 30, radius_x=4 + t, radius_y=4 + t, value=0
        )
        draw_sphere(
            image,
            x=100,
        ...
        draw_sphere(
            image, x=100, y=255 + (t - 1) * 30, radius_x=3 + t, radius_y=3 + t, value=0
        )
        draw_sphere(
            image,
            x=140,
        ...
        draw_sphere(
            image, x=140, y=255 + (t - 1) * 30, radius_x=2 + t, radius_y=2 + t, value=0
        )
