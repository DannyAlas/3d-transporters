...
def label_maximum_extension_ratio_map(
    labels: Image, destination: Image = None
) -> Image:
    ...
    values_vector = push_regionprops_column(
        regionprops, "mean_max_distance_to_centroid_ratio"
    )
