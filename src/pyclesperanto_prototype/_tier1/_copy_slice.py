...
@plugin_function
def copy_slice(source: Image, destination: Image = None, slice_index: int = 0) -> Image:
    ...
    if len(destination.shape) == 3:
        execute(
            __file__,
            "clij-opencl-kernels/kernels/copy_slice_to_3d_x.cl",
            "copy_slice_to_3d",
        ...
        execute(
            __file__,
            "clij-opencl-kernels/kernels/copy_slice_from_3d_x.cl",
            "copy_slice_from_3d",
            destination.shape,
            parameters,
        )
