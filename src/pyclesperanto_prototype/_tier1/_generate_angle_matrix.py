from .._tier0 import (Image, create_matrix_from_pointlists, execute,
                      plugin_function)


@plugin_function(output_creator=create_matrix_from_pointlists)
def generate_angle_matrix(
    coordinate_list1: Image,
    coordinate_list2: Image,
    angle_matrix_destination: Image = None,
) -> Image:
    ...
    * 90 degrees (0.5 pi radians): Bottom
    ...
    execute(
        __file__,
        "clij-opencl-kernels/kernels/generate_angle_matrix_2d_x.cl",
        "generate_angle_matrix",
        angle_matrix_destination.shape,
        parameters,
    )
