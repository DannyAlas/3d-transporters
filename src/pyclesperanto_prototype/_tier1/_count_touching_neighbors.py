...
def count_touching_neighbors(
    touch_matrix: Image,
    touching_neighbors_count_destination: Image = None,
    ...
    #        parameters)
    from .._tier1 import (set_column, set_row, set_where_x_equals_y,
                          sum_y_projection)
    ...
    touching_neighbors_count_destination = sum_y_projection(
        binary_matrix, touching_neighbors_count_destination
    )
