...
def maximum_distance_of_touching_neighbors(
    distance_matrix: Image, touch_matrix: Image, distancelist_destination: Image = None
) -> Image:
    """Takes a touch matrix and a distance matrix to determine the maximum
    ...
    execute(
        __file__,
        "maximum_distance_of_touching_neighbors_x.cl",
