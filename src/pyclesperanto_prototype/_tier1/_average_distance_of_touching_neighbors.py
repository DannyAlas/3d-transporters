...
def average_distance_of_touching_neighbors(
    distance_matrix: Image,
    touch_matrix: Image,
    average_distancelist_destination: Image = None,
) -> Image:
    ...
    execute(
        __file__,
        "clij-opencl-kernels/kernels/average_distance_of_touching_neighbors_x.cl",
        "average_distance_of_touching_neighbors",
        average_distancelist_destination.shape,
        parameters,
    )
