...
def multiply_matrix(
    matrix1: Image, matrix2: Image, matrix_destination: Image = None
) -> Image:
    ...
    parameters = {"dst_matrix": matrix_destination, "src1": matrix1, "src2": matrix2}
    execute(
        __file__,
        "clij-opencl-kernels/kernels/multiply_matrix_x.cl",
        "multiply_matrix",
        matrix_destination.shape,
        parameters,
    )
