from .._tier0 import (Image, create_square_matrix_from_pointlist, execute,
                      plugin_function)


@plugin_function(output_creator=create_square_matrix_from_pointlist)
def point_index_list_to_touch_matrix(
    indexlist: Image, matrix_destination: Image = None
) -> Image:
    ...
    execute(
        __file__,
        "point_index_list_to_touch_matrix_x.cl",
