...
from ._average_distance_of_n_far_off_distances import \
    average_distance_of_n_far_off_distances
from ._average_distance_of_n_far_off_distances import \
    average_distance_of_n_far_off_distances as \
    average_distance_of_n_far_off_points
from ._average_distance_of_n_nearest_distances import \
    average_distance_of_n_nearest_distances
from ._average_distance_of_n_shortest_distances import \
    average_distance_of_n_shortest_distances
from ._average_distance_of_n_shortest_distances import \
    average_distance_of_n_shortest_distances as \
    average_distance_of_n_closest_points
from ._average_distance_of_touching_neighbors import \
...
from ._downsample_slice_by_slice_half_median import \
    downsample_slice_by_slice_half_median
from ._downsample_slice_by_slice_half_median import \
    downsample_slice_by_slice_half_median as downsample_xy_by_half_median
...
from ._maximum_distance_of_n_shortest_distances import \
    maximum_distance_of_n_shortest_distances
from ._maximum_distance_of_n_shortest_distances import \
    maximum_distance_of_n_shortest_distances as \
    maximum_distance_of_n_closest_points
from ._maximum_distance_of_touching_neighbors import \
...
from ._minimum_distance_of_touching_neighbors import \
...
from ._onlyzero_overwrite_maximum_diamond import \
...
from ._set_non_zero_pixels_to_pixel_index import \
    set_non_zero_pixels_to_pixel_index
from ._set_non_zero_pixels_to_pixel_index import \
    set_non_zero_pixels_to_pixel_index as set_nonzero_pixels_to_pixelindex
