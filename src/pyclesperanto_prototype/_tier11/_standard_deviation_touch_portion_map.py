...
def standard_deviation_touch_portion_map(
    labels: Image, std_touch_portion_map_destination: Image = None
) -> Image:
    ...
    * This operation assumes input images are isotropic.
    ...
    return replace_intensities(
        labels, std_touch_portion, std_touch_portion_map_destination
    )
