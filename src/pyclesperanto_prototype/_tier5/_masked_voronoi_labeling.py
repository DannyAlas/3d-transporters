...
def masked_voronoi_labeling(
    binary_source: Image, mask_image: Image, labeling_destination: Image = None
) -> Image:
    ...
    from .._tier0 import create_like, pull, push
    from .._tier1 import (add_image_and_scalar, mask,
